...
from .views import CaseActionViewSet, CaseViewSet, PathwayAssignmentViewSet, ProfilingRecordViewSet
...
router.register("actions", CaseActionViewSet, basename="case-action")
