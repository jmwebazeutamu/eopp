...
export const STRINGS = {
  ...
  "cm.justNow": "just now",
  "cm.week": "This week",
  "cm.weekMeta": "{opened} opened · {closed} closed",
  ...
  "ws.awaitingAlerts": "{count} referrals overdue for confirmation",
  ...
  // Tier 3 cards
  "pm.noCrossovers": "The taxonomy admits one outcome per category, so every cell off the diagonal is forbidden rather than empty. Widening it is a taxonomy decision (§5.3, admin-editable).",
