...
export const STRINGS = {
  ...
  "wlt.candidatesEmpty": "No eligible women are free to join in {kebele}.",
  // The reported fault: an empty picker read as a broken screen. A group
  // recruits from its own kebele — it meets weekly in person — so geography is
  // the usual reason, and saying so turns a dead end into a next step.
  "wlt.candidatesElsewhere":
    "{count} eligible woman is waiting for a group in another kebele. A group recruits only in its own kebele, so she would need a group there.",
  "wlt.candidatesElsewherePlural":
    "{count} eligible women are waiting for a group in other kebeles. A group recruits only in its own kebele, so they would need a group there.",
  ...
  // that refused is recorded rather than discarded.
  // The register's group column. "Not in a group" is written out rather than
  ...
  "wlt.herGroup": "Her savings group",
  "wlt.groupLinkages": "Her group's linkages",
  "wlt.groupPhaseLabel": "Phase",
  "wlt.groupKebeleLabel": "Kebele",
  "wlt.groupFacilitatorLabel": "Facilitator",
  "wlt.groupMembersLabel": "Members",
  "wlt.groupJoinedLabel": "She joined",
  "wlt.linkageActiveSince": "active since {date}",
  "wlt.linkageOpened": "opened {date}",
  "wlt.noGroupLinkages": "Her group holds no linkages yet.",
  ...
  "wlt.draftGroupIntro": "A group starts with the community",
  "wlt.draftGroupIntroBody":
    "A group is drafted from a community meeting that endorsed it. Once drafted you can add members, then constitute and activate it.",
  "wlt.communityMeeting": "Community meeting",
  ...
  "wlt.attendeesHusbands": "Husbands attending",
  "wlt.attendeesElders": "Elders attending",
  "wlt.attendeesLeaders": "Kebele leaders attending",
  "wlt.endorsementObtained": "The community endorsed the group",
  "wlt.endorsementNote": "Note (optional)",
  ...
  "wlt.groupNameHelp": "The name the women use for it.",
  "wlt.groupDrafted": "{name} is drafted. Add members next.",
  "wlt.groupDraftFailed": "The group could not be drafted.",
  ...
  "wlt.journeySequence": "Complete programme sequence",
  "wlt.stateDone": "Done",
